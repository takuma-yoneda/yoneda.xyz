...
|:---------------------:|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|
| Entropy               | $$H(P) = E_{x\sim P} [- \ln P(x)]$$                                                                                                                                              | Average of minus log probability.                                                                                   |
| Cross-Entropy         | $$H(P, Q) = E_{x \sim P} [- \ln Q(x)]$$                                                                                                                                          | The average number of nats (bits) to represent $x$ using the imperfect code defined by $Q$ (data compression view). |
| KL Divergence         | $$\begin{aligned} KL(P, Q) &= H(P, Q) - H(P) \\ &= E_{x\sim P} [-\ln \frac{Q(x)}{P(x)}] \end{aligned}$$                                                                            | How many more nats (bits) is required to represent $x$ with code $Q$ compared with the optimal code ($P$).          |
